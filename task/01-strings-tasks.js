...
function removeFirstOccurrences(str, value) {
    return str.slice(0, str.indexOf(value)) + str.substring(str.indexOf(value) + value.length)
}
...
function encodeToRot13(str) {
    ...
    var after = "NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm"
    var result = "";
    for (i = 0; i < str.length; i++){
        if (before.indexOf(str.charAt(i)) != -1){
            result += after.charAt(before.indexOf(str.charAt(i)));
        } else {
            result += str.charAt(i);
        }
    }
